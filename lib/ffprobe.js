...
function parseFfprobeOutput(out) {
  ...
  /* Quick fix to handle avprobes different output format.
  TODO:
  - separate parser?
  - handle tags */
  var isAvProbe = lines.length > 0 ? lines[0].match(/avprobe/i) !== null : false;
  ...
  function parseBlock(name) {
    ...
    while (typeof line !== 'undefined') {
      /* avprobe dont end each block, instead there is an empty line */
